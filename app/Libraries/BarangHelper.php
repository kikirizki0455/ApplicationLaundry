...
class BarangHelper
{
    ...
    public function checkDuplicate($name)
    {
        ...
        $similar_items = $this->db->table('barang')
            ->select('nama_barang')
            ->get()
            ->getResult();

        foreach ($similar_items as $item) {
            $similarity = $this->advancedSimilarity($normalized_name, $item->nama_barang);
    ...
    public function validateBarangData($data)
    {
        $rules = [
            'nama_barang' => [
            ...
            'stok' => [
                ...
                'errors' => [
                    ...
                    'greater_than_equal_to' => 'Stok barang tidak boleh negatif.'
                ]
            ]
        ];
